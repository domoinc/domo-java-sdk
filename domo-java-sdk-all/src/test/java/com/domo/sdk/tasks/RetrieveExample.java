...
public class RetrieveExample extends ExampleBase {
    ...
    public void tasksClient_smokeTest() throws IOException {
        ...
        //Get a project
        Project getProject = tasksClient.getProject(projectResponse.getId());
        ...
        //Get a List
        ProjectList getList = tasksClient.getProjectList(projectResponse.getId(), listResponse.getId());
        ...
        //Get a Task
        Task getTask = tasksClient.getTask(projectResponse.getId(), listResponse.getId(), taskResponse.getId());
        ...
        InputStream getAttachment = tasksClient.downloadAttachment(projectResponse.getId(), listResponse.getId(), taskResponse.getId(), attachmentResponse.getId().toString());
    }
}
